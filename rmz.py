...
def usage():
	print 'Coba command ini  http://webtarget.com'
	print "\a"
print"By H 7-9 SEN | Remake By ==RMZ-28=="
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print '[+] ~> Attack Dikirim Gann  . . . . <~ [+]'
			print '[-] ~>   RMZ-28  Ft  PureHacker ? Indonesian Unders Site ? Black Hammer Team   <~ [-]'
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "RMZ-28  Ft  PureHacker ? Black Hammer Team ? Indonesian Under Site"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
